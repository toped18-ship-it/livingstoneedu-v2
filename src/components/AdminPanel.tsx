                ...
                <div className="space-y-6 text-left animate-fade-in">
                  <div className="p-5 bg-red-50/50 border border-red-200 rounded-2xl flex items-center justify-between flex-wrap gap-4">
                    ...
                    <button
                      type="button"
                      onClick={async () => {
                        if (window.confirm('CRITICAL WARN: Are you absolutely sure you want to completely purge ALL curriculum alignments and lesson notes from Firebase Realtime Database? This cannot be undone!')) {
